...
\begin{center}
  \begin{minipage}{\contentwidth}
    \begin{minipage}{\innerwidth}
      ...
      % --- FILA 1 ---
      \begin{tabularx}{\textwidth}{X @{\hspace{6mm}} p{0.22\textwidth} @{\hspace{6mm}} p{0.18\textwidth}}
      ...
      % --- FILA 2 ---
      \begin{tabularx}{\textwidth}{p{0.30\textwidth} @{\hspace{6mm}} X}
...
% ===== CONTENIDO LÍQUIDOS =====
% Nota de layout:
% Se separa la sección en 2 bloques para permitir salto de página únicamente
% antes de "Comentarios adicionales" + "Líquido limpiaparabrisas".
\begin{center}
  \begin{minipage}{\contentwidth}
    \begin{minipage}{\innerwidth}
...
% Bloque separable: si no cabe al final de página, baja completo a la siguiente.
\vspace{4mm}
\begin{center}
  \begin{minipage}{\contentwidth}
    \begin{minipage}{\innerwidth}
