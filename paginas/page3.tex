  ...
  \begin{tabular}{@{}p{0.485\linewidth}@{\hspace{3mm}}p{0.485\linewidth}@{}}
    \begin{tcolorbox}[
      ...
      \begin{tcolorbox}[
        ...
        {\fontsize{12}{12.4}\selectfont REVISADOR POR}
      \end{tcolorbox}
      \vspace{2.1mm}
      \centering{\fontsize{17}{18}\selectfont\bfseries Señor mecánico juanito}
      \vspace{2.7mm}
    \end{tcolorbox}
    &
    \begin{tcolorbox}[
      ...
      \begin{tcolorbox}[
        ...
        {\fontsize{12}{12.4}\selectfont SUCURSAL}
      \end{tcolorbox}
      \vspace{2.1mm}
      \centering{\fontsize{17}{18}\selectfont\bfseries Matriz lázaro cárdenas}
      \vspace{2.7mm}
    \end{tcolorbox}
  \end{tabular}
\end{minipage}%
