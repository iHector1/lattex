...
\newcommand{\ShockClosureCardReviewer}[3]{%
  \begin{tcolorbox}[
    enhanced,
    nobeforeafter,
    width=\linewidth,
    ...
    \begin{tcolorbox}[
      ...
      {\fontsize{14.2}{15}\selectfont\bfseries #2}\\[-0.2mm]
      {\fontsize{10.8}{11.5}\selectfont\color{black!65} #3}
    \end{tcolorbox}
  \end{tcolorbox}%
}
...
\begin{minipage}{\contentwidth}
  {\kodemono\fontseries{b}\fontsize{11}{14}\selectfont Inspección de Amortiguadores y Bases Delanteras}
\end{minipage}%
}
...
\begin{minipage}{\contentwidth}
  ...
  \begin{tabular}{@{}p{0.485\linewidth}@{\hspace{3mm}}p{0.485\linewidth}@{}}
    \ShockClosureCardReviewer{REVISADOR POR}{Señor mecánico juanito}{Vie, 20 febrero 2026}
    &
