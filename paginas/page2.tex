...
\newcommand{\WheelLogoMaxWidth}{0.92\linewidth}
\newcommand{\WheelLogoMaxHeight}{5.8mm} % limites maximos del logo (mantiene proporcion)
\newcommand{\WheelCarFile}{carro.png}
\newcommand{\WheelCarWidth}{1.08\linewidth}
\newcommand{\WheelCarTopSpace}{1.4mm}
\newcommand{\WheelCarBottomSpace}{1.4mm}
\newcommand{\WheelSideLift}{-11mm}
\newcommand{\WheelCarDrop}{-4mm} % mas negativo = carro mas abajo

% -- Control de layout horizontal (tarjetas y separación al carro) --
...
% -- Distribución en 3 columnas (izquierda | carro | derecha) --
\noindent\makebox[\textwidth][c]{%
\begin{minipage}{\contentwidth}
  ...
  \begin{minipage}[c]{\WheelCarColWidth}
