...
% -- Llanta y modelo por posición (cada bloque es independiente) --
...
\begin{minipage}{\contentwidth}
  ...
  \begin{minipage}[t]{\WheelSideColWidth}
    \SimpleWheelBlock{Delantera Derecha}{\WheelLogoFileFrontRight}{\WheelModelNameFrontRight}{315/35/R21}{25}{3 mm}{9 mm}{8 mm}
    \vspace{2.2mm}
    \SimpleWheelBlock{Trasera Derecha}{\WheelLogoFileRearRight}{\WheelModelNameRearRight}{315/35/R21}{25}{3 mm}{9 mm}{8 mm}
  \end{minipage}%
  }%
  ...
  \raisebox{\WheelCardRaise}{%
  \begin{minipage}[t]{\WheelSideColWidth}
    \SimpleWheelBlock{Delantera Izquierda}{\WheelLogoFileFrontLeft}{\WheelModelNameFrontLeft}{315/35/R21}{25}{3 mm}{9 mm}{8 mm}
    \vspace{2.2mm}
    \SimpleWheelBlock{Trasera Izquierda}{\WheelLogoFileRearLeft}{\WheelModelNameRearLeft}{315/35/R21}{25}{3 mm}{9 mm}{8 mm}
  \end{minipage}%
  }
...
\newcommand{\BatteryVoltajeTexto}{Voltaje (v)}
\newcommand{\BatteryVoltajeValor}{12}
\newcommand{\BatteryComentariosTexto}{}

% Reutiliza el selector visual de 4 estados para mantener homogeneidad
\newcommand{\BatteryStatusSelector}[1]{%
  \SuspensionStatusSelector{#1}%
}

% Tarjeta de voltaje estilo compacto (encabezado amarillo + valor limpio)
\newcommand{\BatteryVoltageCard}[2]{%
  \begin{tcolorbox}[
    enhanced,
    nobeforeafter,
    width=\linewidth,
    ...
    \begin{tcolorbox}[
      ...
      {\fontsize{7.8}{8.6}\selectfont\bfseries #1}
    \end{tcolorbox}
    \begin{tcolorbox}[
      enhanced,
      nobeforeafter,
...
\noindent\makebox[\textwidth][c]{%
  \begin{tcolorbox}[
    ...
    \centering
    {\fontsize{15}{18}\selectfont \bfseries Batería}
  \end{tcolorbox}%
}
...
\noindent\makebox[\textwidth][c]{%
\begin{minipage}{\contentwidth}
  {\fontsize{13}{14}\selectfont Inspección de Batería}
\end{minipage}%
}

\vspace{0.9mm}

% -- Fila: condición general + voltaje + comentarios --
\noindent\makebox[\textwidth][c]{%
\begin{minipage}{\contentwidth}
  \begin{minipage}[t]{0.31\linewidth}
    {\fontsize{7.2}{11}\selectfont Condición general}
    \vspace{0.8mm}

    \BatteryStatusSelector{\BatteryEstado}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.14\linewidth}
    \vspace{1.5mm}
    \BatteryVoltageCard{\BatteryVoltajeTexto}{\BatteryVoltajeValor}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.50\linewidth}
    {\fontsize{7.2}{11}\selectfont Comentarios adicionales}
    \vspace{0.8mm}
    ...
    \begin{tcolorbox}[
      ...
      {\fontsize{7.2}{8.5}\selectfont \BatteryComentariosTexto}
    \end{tcolorbox}
  \end{minipage}
\end{minipage}%
}
