...
\newcommand{\SimpleWheelBlock}[8]{%
  ...
  \begin{tcolorbox}[enhanced,nobeforeafter,
    ...
    \setlength{\tabcolsep}{0pt}
    \begin{tabular}{@{}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricDepthColW}@{}}
