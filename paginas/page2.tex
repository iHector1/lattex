...
\newcommand{\StaticFieldColor}[2]{%
  \begin{tcolorbox}[enhanced,nobeforeafter,
    ...
    {\kodemono\fontsize{\WheelInfoFontSize}{\WheelInfoFontLead}\selectfont #1}
  \end{tcolorbox}%
}
  ...
  \begin{tcolorbox}[enhanced,nobeforeafter,
    ...
    \begin{tabular}{@{}p{\WheelLogoColRatio\linewidth}p{\WheelModelColRatio\linewidth}@{}}
      ...
      \begin{tcolorbox}[enhanced,nobeforeafter,
        ...
        {\kodemono\fontsize{\WheelInfoFontSize}{\WheelInfoFontLead}\selectfont #3}
      \end{tcolorbox}
      \\
    \end{tabular}
