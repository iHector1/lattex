...
\newcommand{\WheelMetricFiveColW}{0.18\linewidth}
...
\newcommand{\WheelBrakeCellGrayGreen}[1]{%
  \begin{tcolorbox}[enhanced,nobeforeafter,
    ...
    boxsep=0mm,left=0.8mm,right=0.8mm,top=0mm,bottom=0mm,
    valign=center,halign=center
  ]{{\fontsize{\WheelBrakeFontSize}{\WheelBrakeFontLead}\selectfont\bfseries\color{\WheelBrakeGreenText} #1}}\end{tcolorbox}%
}
...
\newcommand{\SimpleWheelBlock}[8]{%
  ...
  \begin{tcolorbox}[enhanced,nobeforeafter,
    ...
    \setlength{\tabcolsep}{0pt}
    \begin{tabular}{@{}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{\hspace{\WheelMetricColGap}}p{\WheelMetricFiveColW}@{}}
