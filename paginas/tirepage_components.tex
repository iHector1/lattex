...
\newcommand{\TPCardHeader}[2]{%
  ...
  \tcbox[
    ...
    \begin{minipage}[c][11.5mm][c]{\linewidth}%
      \raggedright%
      \fontsize{11.2}{12.8}\selectfont\bfseries #2%
    \end{minipage}%
  }%
}
...
\newcommand{\TPMetric}[2]{%
  \begin{tcolorbox}[
    ...
    \tcbox[
      ...
      valign=center,
      halign=center
    ]{\fontsize{11.2}{12.5}\selectfont\bfseries #1}%
    \vspace{2.2mm}%
    \tcbox[
      enhanced,
      ...
      valign=center,
      halign=center
    ]{\fontsize{13.8}{15.6}\selectfont\bfseries #2}%
  \end{tcolorbox}%
}
...
\newcommand{\TPMetricPSI}[1]{%
  \begin{tcolorbox}[
    ...
    \tcbox[
      ...
      valign=center,
      halign=center
    ]{\fontsize{11.2}{12.5}\selectfont\bfseries PSI}%
    ...
    \tcbox[
      ...
      height=5.8mm,
      valign=center, halign=center
    ]{\fontsize{6.6}{7.6}\selectfont\bfseries\color{white} RECOMENDADO}%
    \tcbox[
      on line, enhanced,
      ...
      height=5.8mm,
      valign=center, halign=center
    ]{\fontsize{6.6}{7.6}\selectfont\bfseries\color{white} ACTUAL}%
    ...
    \tcbox[
      ...
      height=12.8mm,
      valign=center, halign=center
    ]{\fontsize{13.8}{15.6}\selectfont\bfseries \TPFirst{#1}}%
    \tcbox[
      on line, enhanced,
      colback=valuegray, colframe=valuegray,
      boxrule=0pt, arc=2mm,
      ...
      height=12.8mm,
      valign=center, halign=center
    ]{\fontsize{13.8}{15.6}\selectfont\bfseries \TPSecond{#1}}%
  \end{tcolorbox}%
}
