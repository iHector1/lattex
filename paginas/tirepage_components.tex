...
\newcommand{\TPCardHeader}[2]{%
  ...
  \begin{tcolorbox}[
    ...
    \begin{minipage}[c][10.5mm][c]{0.30\linewidth}
      \tcbox[
        enhanced,
      ...
      ]{\includegraphics[height=5.1mm]{#1}}%
    \end{minipage}%
    \begin{minipage}[c][10.5mm][c]{0.70\linewidth}
      \tcbox[
        enhanced,
        colback=headgray, colframe=headgray,
        boxrule=0pt, arc=0mm,
        left=2.3mm, right=2mm, top=0mm, bottom=0mm,
        width=\linewidth,
        height=10.5mm,
        valign=center,
        halign=left
      ]{\fontsize{10.2}{11.6}\selectfont\bfseries #2}%
    \end{minipage}%
  \end{tcolorbox}%
}
