...
\begin{center}
  \begin{minipage}{\contentwidth}
    \begin{minipage}{\innerwidth}
      ...
      % Subtítulo (Kode Mono)
      {\kodemono\fontseries{sb}\fontsize{12}{14}\selectfont Información General del Vehículo}
      \vspace{2mm}
...
\begin{center}
  \begin{minipage}{\contentwidth}
    \begin{minipage}{\innerwidth}
      ...
      \vspace{1.5mm}
      {\kodemono\fontseries{sb}\fontsize{12}{14}\selectfont Inspección de Líquidos}
      \vspace{1.5mm}
