...
% FUENTES
% =========================
% Montserrat local (coloca aquí los 4 archivos .ttf)
\setmainfont[
...
% =========================
\begin{document}
% Footer fijo en página 1, independiente del contenido
\AddToShipoutPictureBG{%
  \ifnum\value{page}=1
    \AtPageLowerLeft{\includegraphics[width=\paperwidth]{botton.png}}%
  \fi
}
\input{paginas/page1}
\input{paginas/page2}
