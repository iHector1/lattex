...
% =========================
% Nota:
% En algunos Ubuntu/Debian, FontConfig puede resolver "Montserrat" a .woff2
% (por ejemplo /usr/share/fonts/woff/...), y XeLaTeX no puede incrustar ese
% formato. Para evitarlo, priorizamos archivos TTF/OTF explícitos.
\IfFileExists{./configuraciones/Montserrat-Regular.ttf}{%
  \setmainfont[
  ...
  \IfFileExists{/usr/share/fonts/truetype/montserrat/Montserrat-Regular.ttf}{%
    \setmainfont[
    ...
    \IfFileExists{/usr/share/fonts/opentype/montserrat/Montserrat-Regular.otf}{%
      \setmainfont[
      ...
      \typeout{[LaTTeX] Aviso: Montserrat no encontrada en TTF/OTF. Usando TeX Gyre Heros como fallback.}
    }%
  }%
}
...
\newfontfamily\kodemono[
  ...
  Extension=.ttf,
  UprightFont=*,
  UprightFeatures={RawFeature={+wght=500}, FakeBold=1.2},
  FontFace={l}{n}{Font=*, RawFeature={+wght=450}, FakeBold=0.9},
  FontFace={m}{n}{Font=*, RawFeature={+wght=550}, FakeBold=1.2},
  FontFace={sb}{n}{Font=*, RawFeature={+wght=700}, FakeBold=1.5},
  FontFace={b}{n}{Font=*, RawFeature={+wght=800}, FakeBold=1.8}
...
\newcommand{\gasolinebar}[1]{%
  \noindent\makebox[\innerwidth][c]{%
    \begin{tikzpicture}
      ...
      \coordinate (Cright) at ($(L)!0.99!(Rr)$);
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}
        ...
        \fitem{\xB}{\ifnum#1=1 1\else 0\fi}{green!60!black}{A Nivel}{}
        \fitem{\xC}{\ifnum#1=2 1\else 0\fi}{warningyellow}{Arriba del}{Nivel}
